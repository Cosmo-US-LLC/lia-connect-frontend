...
const Sidebar = (props) => {
  ...
  const [mainmenu, setMainMenu] = useState(MENUITEMS[0][menuType]);
  ...
  const setNavActive = (item) => {
    MENUITEMS[0][menuType].map((menuItems) => {
        ...
        <nav className="sidebar-main">
          ...
          >
            <ul className="sidebar-links custom-scrollbar">
              ...
              {MENUITEMS[0][menuType].map((Item, i) => (
                <Fragment key={i}>
                  ...
                  {Item.Items.map((menuItem, i) => (
                    <li className="sidebar-list" key={i}>
                      {menuItem.type === "sub" ? (
                        menuItem.roleAccess?.includes(role.id) ? (
                          <a
