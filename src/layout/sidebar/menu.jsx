import { Home, Box, Activity, Book, FolderPlus, Command, Cloud, FileText, Server, BarChart, Users, Layers, ShoppingBag, List, Mail, MessageCircle, GitPullRequest, Monitor, Heart, Clock, Zap, CheckSquare, Calendar, Image, Film, HelpCircle, Radio, Map, Edit, Sunrise, Package } from 'react-feather'
                ...
                Items: [

                    {
                        title: 'Manage Users', icon: Users, type: 'sub', active: false, children: [
                            { path: `${process.env.PUBLIC_URL}/user/view`, title: 'Admin', type: 'link' },
                            { path: `${process.env.PUBLIC_URL}/clients/manage/very-rich`, title: 'Branch Admin', type: 'link' },
                            { path: `${process.env.PUBLIC_URL}/clients/manage/rich`, title: 'Branch Staff', type: 'link' },
                        ],
                        roleAccess: [2]
                    },
                    {
                        title: 'Manage Branches', icon: GitPullRequest, type: 'sub', active: false, children: [
                            { path: `${process.env.PUBLIC_URL}/branch`, title: 'Branches', type: 'link' },
                            { path: `${process.env.PUBLIC_URL}/branch/create-branch`, title: 'Create Branch', type: 'link' },

                        ],
                        roleAccess: [2]
                    },

                    { path: `${process.env.PUBLIC_URL}/superadmin/schools`, icon: Home, title: 'School Requests', type: 'link', roleAccess: [1] },

                    { path: `${process.env.PUBLIC_URL}/home`, icon: Home, title: 'Overview', type: 'link', roleAccess: [4] },
                    { path: `${process.env.PUBLIC_URL}/class`, icon: Activity, title: 'Classes', type: 'link', roleAccess: [4] },
                    { path: `${process.env.PUBLIC_URL}/teacher`, icon: Book, title: 'Teacher', type: 'link', roleAccess: [4] },
                    { path: `${process.env.PUBLIC_URL}/student`, icon: Activity, title: 'Student', type: 'link', roleAccess: [4] },
                    { path: `${process.env.PUBLIC_URL}/family`, icon: Book, title: 'Families', type: 'link', roleAccess: [4] },
                    { path: `${process.env.PUBLIC_URL}/skills`, icon: Activity, title: 'Skills', type: 'link', roleAccess: [4] },
                    { path: `${process.env.PUBLIC_URL}/analytics`, icon: Book, title: 'Analytics', type: 'link', roleAccess: [4] },
                ]
            },
        ...
        clients: [
            {
                ...
                menucontent: "",
                Items: [
                    { path: `${process.env.PUBLIC_URL}/clients/summary`, icon: MessageCircle, title: 'Summary', type: 'link' },
                    {
                        title: 'Manage Clients', icon: Users, type: 'sub', active: false, children: [
                            { path: `${process.env.PUBLIC_URL}/clients/manage/all`, title: 'All', type: 'link' },
                            { path: `${process.env.PUBLIC_URL}/clients/manage/very-rich`, title: 'Very Rich', type: 'link' },
                            { path: `${process.env.PUBLIC_URL}/clients/manage/rich`, title: 'Rich', type: 'link' },
                            { path: `${process.env.PUBLIC_URL}/clients/manage/middle-class`, title: 'Middle Class', type: 'link' },
                            { path: `${process.env.PUBLIC_URL}/clients/manage/lower-middle`, title: 'Lower Middle', type: 'link' },
                            { path: `${process.env.PUBLIC_URL}/clients/manage/poor`, title: 'Poor', type: 'link' },
                        ]
                    },

                    { path: `${process.env.PUBLIC_URL}/clients/search`, icon: MessageCircle, title: 'Search Clients', type: 'link' },
                    { path: `${process.env.PUBLIC_URL}/clients/add`, icon: MessageCircle, title: 'Add Client', type: 'link' },
                    { path: `${process.env.PUBLIC_URL}/clients/manage/deleted`, icon: MessageCircle, title: 'Deleted Clients', type: 'link' },
