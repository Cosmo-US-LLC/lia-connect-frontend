      ...
      <Col className="left-header horizontal-wrapper pl-0">
        <ul className="horizontal-menu">
          <li className="mega-menu outside">
            ...
            <Link className={`ml-2 nav-link ${dashboardNav ? 'active' : ''}`}
              onClick={() => { props.onchange('dashboard'); handleChangeNav('dashboard') }} to={'/dashboard'}>{DashboardNav}
            </Link>

            <Link className={`ml-2 nav-link ${clientNav ? 'active' : ''}`}
              onClick={() => { props.onchange('clients'); handleChangeNav('clients') }} to={'/clients/summary'}>{ClientNav}
            </Link>
