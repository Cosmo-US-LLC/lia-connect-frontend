...
import { Activity, RecentActivity, DailyDropdown } from '../../../constant';
import { ActivityData } from '../../../Data/DefaultDashboard';
import DropdownCommon from '../../Common/Dropdown';

const ActivityCard = () => {
  return (
    <Col xxl='6' xl='6' md='6' sm='7' className='notification box-col-6 ' style={{ marginBottom: '50px' }}>
      <Card className='height-equal'>
        <CardHeader className='card-no-border'>
          <div className='header-top'>
            <H5 attrH5={{ className: 'm-0' }}>{RecentActivity}</H5>
