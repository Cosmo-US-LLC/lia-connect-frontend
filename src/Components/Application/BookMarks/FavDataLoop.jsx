...
const FavDataLoop = () => {
  const { mybookmarkData, removemybookmark, updatebookmark } =
                ...
                <Card className="card-with-border bookmark-card o-hidden">
                  <div className="details-website">
                    <Image
                      attrImage={{
                        className: "img-fluid",
                        src: `${require(`../../../assets/images/${mybookdata.image}`)}`,
                        alt: "",
                      }}
                    />
                    <div
                    ...
                    >
                      <a href="#javascript">
                        <i
                          ...
                          onClick={() => Remove_from_favourite(mybookdata)}
                        ></i>
                      </a>
                    </div>
                        ...
                        <div className="hover-block">
                          <UL attrUL={{ className: "simple-list flex-row" }}>
                            <LI attrLI={{ className: "border-0" }}>
                              <a
                                href="#javascript"
                                onClick={() => editbookmarkdata(mybookdata)}
                              >
                            ...
                            <LI attrLI={{ className: "border-0" }}>
                              <a
                                href="#javascript"
                                onClick={() =>
                                  Remove_from_my_bookmark(mybookdata.id)
                                }
                              >
                                {" "}
                            ...
                            <LI
                              attrLI={{
                                className: "border-0 pull-right text-end",
                              }}
                            >
                              {" "}
                              <a href="#javascript">
