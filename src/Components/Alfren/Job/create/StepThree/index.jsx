...
const StepThree = ({ handlePrevious, handleNext, jobId, messageBody, setMessageBody, category, setCategory }) => {
  const [isLoading, setIsLoading] = useState(false)
  ...
  const handleNextStep = async (e) => {
    ...
    try {
      // Simulate API call - replace with your actual Redux dispatch
      ...
      // Here you would dispatch your Redux action
      // dispatch(updateJob(formData, callback));
  ...
  const categories = [
    {
      ...
      description: "Captures a broad spectrum of candidates with diverse skill sets.",
      note: ["Lower skill match threshold", "Targets a wider range of candidates"],
    },
    {
      title: "Targeted Evaluation",
  ...
  const isFormValid = messageBody.length >= 10 && messageBody.length <= 500 && category
            ...
            <Card>
              <CardBody>
                    ...
                    <div className="d-flex gap-3 pb-4 flex-wrap">
                      {categories.map((cat) => (
                        <div
                          ...
                          onClick={() => setCategory(cat.title)}
                          className={`p-4 rounded-3 text-center ${
                            category === cat.title ? "border-primary bg-light" : "bg-white"
                          }`}
                          style={{
                            flex: 1,
                            minWidth: "280px",
                            ...
                            borderStyle: "solid",
                            transition: "all 0.2s ease",
                            border: category === cat.title ? "2px solid #007bff" : "2px solid #e9ecef",
                            boxShadow:
                              category === cat.title
                                ? "0 4px 20px rgba(0, 123, 255, 0.2)"
                                : "0 2px 10px rgba(0,0,0,0.05)",
                        ...
                        >
                          ...
                          <h6
                            style={{
                              ...
                              marginTop: "10px",
                              textAlign: "left",
                              color: category === cat.title ? "#007bff" : "#333",
                            }}
                          >
                            {cat.title}
                          </h6>
                          <p
                            style={{
                              fontSize: "13px",
                              textAlign: "left",
                              color: category === cat.title ? "#007bff" : "#666",
                              lineHeight: "1.4",
                            }}
                          >
                            {cat.description}
                          ...
                          <ul className="list-unstyled mt-3" style={{ textAlign: "left" }}>
                            {cat.note.map((item, index) => (
                              <li
                                ...
                                style={{
                                  fontSize: "12px",
                                  color: category === cat.title ? "#007bff" : "#999",
                                  marginBottom: "4px",
                                }}
                              >
                                <span
                                  style={{
                                    ...
                                    width: "4px",
                                    height: "4px",
                                    backgroundColor: category === cat.title ? "#007bff" : "#999",
                                    borderRadius: "50%",
                                    marginRight: "8px",
                                  }}
                                ></span>
                ...
                <Row>
                  <Col xl="12" className="mb-4 mt-4">
                    <FormGroup>
                      ...
                      <textarea
                        ...
                        className="form-control shadow-none"
                        style={{
                          borderColor: messageBody.length < 10 && messageBody.length > 0 ? "#dc3545" : "#ced4da",
                          color: "#495057",
                          fontSize: "14px",
                        }}
                      />
                      <div className="text-end mt-2" style={{ fontSize: "12px", color: "#6c757d" }}>
                        {messageBody.length} / 500 characters
                      </div>
                      {messageBody.length < 10 && messageBody.length > 0 && (
                        <div className="text-danger text-start mt-1" style={{ fontSize: "12px" }}>
                          Message must be at least 10 characters.
                        </div>
                      )}
                    </FormGroup>
                  ...
                  <Col xl="12" style={{ textAlign: "center", marginBottom: "50px" }}>
                    <Link
                      onClick={handleBackStep}
                    ...
                    <Link
                      onClick={handleNextStep}
                      className={`btn btn-primary pe-5 ps-5 pt-2 pb-2 ${!isFormValid || isLoading ? "disabled" : ""}`}
                      style={{
                        textDecoration: "none",
