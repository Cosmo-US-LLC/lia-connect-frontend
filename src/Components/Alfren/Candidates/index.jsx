...
import { Breadcrumbs, Image, LI, ToolTip, UL } from "../../../AbstractElements";
        ...
        <div style={{ textAlign: "right" }}>
          ...
          >
            <div>
              ...
              <UL>
                <LI>
                  The blacklisted profile will not be blocked from LinkedIn. It
                  will only be blacklisted within the system.
                </LI>
                <LI>
                  The system will not allow the user to perform actions on the
                  profile which is blacklisted.{" "}
                </LI>
              </UL>
            </div>
          </ToolTip>
